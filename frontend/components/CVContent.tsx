      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="mb-8 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
          ...
          <div className="flex gap-3 flex-wrap">
            ...
            <button
              onClick={() => setShowMode(showMode === 'rendered' ? 'iframe' : 'rendered')}
            ...
            >
              ...
              {showMode === 'rendered' ? 'View HTML Version' : 'View Rendered'}
            </button>
            <a
              href={cvUrl}
              target="_blank"
          ...
          <div className="bg-white rounded-lg shadow-lg p-8 md:p-12 max-w-4xl mx-auto">
            ...
            <header className="mb-8 pb-6 border-b-2 border-primary-600">
              ...
              <div className="flex flex-wrap gap-3 mt-4">
                {website && (
                  <a href={website} target="_blank" rel="noopener noreferrer" className="text-primary-600 hover:text-primary-700 text-sm">
                    🌐 Website
                  </a>
                )}
                {linkedin && (
                  <a href={linkedin} target="_blank" rel="noopener noreferrer" className="text-primary-600 hover:text-primary-700 text-sm">
                    💼 LinkedIn
                  </a>
                )}
                {github && (
                  <a href={github} target="_blank" rel="noopener noreferrer" className="text-primary-600 hover:text-primary-700 text-sm">
                    💻 GitHub
                  </a>
                )}
              </div>
              ...
              <section className="mb-8">
                ...
                <div className="space-y-6">
                  {workExperiences.map((exp) => {
                    const { company, position, startDate, endDate, current, location: expLocation, description, achievements, technologies } = exp.attributes;
        ...
        <div className="mt-6 text-center text-sm text-gray-500">
          <p className="text-gray-400 text-xs">
            💡 This CV is automatically regenerated every 60 seconds and when content is updated in Strapi.
          </p>
        </div>
      </div>
    </div>
