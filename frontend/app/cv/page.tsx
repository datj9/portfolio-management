...
export default async function CVPage() {
  try {
    const [introResponse, workExpResponse] = await Promise.all([
      getIntroduction(),
      getWorkExperiences(),
    ]);
                ...
                <ol className="list-decimal list-inside space-y-2 text-gray-700">
                  ...
                  <li>
                    ...
                    <ul className="list-disc list-inside ml-6 mt-1 text-sm">
                      ...
                      <li><strong>Work Experiences</strong>: Add at least one job and publish it</li>
                    </ul>
                  </li>
    ...
    return <CVContent introduction={introduction} workExperiences={workExperiences} />;
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          <div className="bg-red-50 border-2 border-red-200 rounded-lg p-8">
            ...
            <p className="text-red-600 mb-4">
              Unable to load CV content from Strapi. Please ensure Strapi is running and accessible.
            </p>
            <a
